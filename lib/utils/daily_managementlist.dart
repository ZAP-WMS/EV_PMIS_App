...
List<String> adminsfucolumnNames = [
  'Date',
  'sfuNo',
  'fuc',
  'icc',
...
List<String> adminsfucolumnLabelNames = [
  'Date',
  'SFU No',
  'Fuse unit Condition',
...
List<String> adminchargercolumnNames = [
  'Date',
  'CN',
  'DC',
  'CGCA',
...
List<String> adminchargercolumnLabelNames = [
  'Date',
  'Charger No',
  'Display Condition',
  'CGCA',
...
List<String> adminpsscolumnNames = [
  'Date',
  'pssNo',
  'pbc',
  'ec',
...
List<String> adminpsscolumnLabelNames = [
  'Date',
  'PSS No',
  'PSS Body Condition',
  'Earthing Condition',
...
List<String> admintransformercolumnNames = [
  'Date',
  'trNo',
  'pc',
  'ec',
...
List<String> admiintransformerLabelNames = [
  'Date',
  'Tr. No',
  'Physical Condition',
  'Earthing Condition',
...
List<String> adminrmucolumnNames = [
  'Date',
  'rmuNo',
  'sgp',
  'vpi',
...
List<String> adminrmuLabelNames = [
  'Date',
  'RMU No.',
...
List<String> adminacdbcolumnNames = [
  'Date',
  'incomerNo',
  'vi',
  'vr',
...
List<String> adminacdbLabelNames = [
  'Date',
  'Incomer No',
  'Voltage indicator',
  'Voltmeter Reading',
...
List<String> monthlyChargerColumnName = [
  'cn',
  'date',
  'gun1',
  'gun2',
...
List<String> monthlyAdminchargerLabelColumnName = [
  'Charger No',
  'Date',
  'Gun-1 Reading',
  'Gun-2 Reading',
...
List<String> monthlyAdminFilterName = [
  'Charger No',
  'Date',
...
List<String> monthlyFilterColumnName = [
  'cn',
  'date',
  'fcd',
  'dgcd',
