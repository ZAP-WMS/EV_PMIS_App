...
class KeyDataSourceKeyEvents extends DataGridSource {
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    ...
    if (dataIndex != null) {
      ...
      calculateDelay =
          getActualEnddate.add(const Duration(days: 1)).difference(getEndDate);
      originalDuration =
          getEndDate.add(const Duration(days: 1)).difference(getStartDate);
                              ...
                              : dataGridCell.columnName == 'Progress'
                                  ...
                                  : dataGridCell.columnName == 'QtyExecuted'
                                      ...
                                      : dataGridCell.columnName == 'QtyScope'
                                          ...
                                          : dataGridCell.columnName == 'Weightage'
                                              ? Text('${dataGridCell.value.toStringAsFixed(2)}%',
                                                  style: indicesToSkip.contains(dataIndex)
                                                      ? TextStyle(fontSize: 12, color: white)
                                                      : const TextStyle(
                                                          fontSize: 12,
                                              ...
                                              : dataGridCell.columnName == 'BalancedQty'
                                                  ...
                                                  : dataGridCell.columnName == 'Delay'
                                                      ...
                                                      : (dataGridCell.columnName == 'ActualStart' && (dataIndex != 0 && dataIndex != 2 && dataIndex != 6 && dataIndex != 13 && dataIndex != 18 && dataIndex != 28 && dataIndex != 32 && dataIndex != 38 && dataIndex != 64 && dataIndex != 76))
                                                          ? Row(
                                                              children: [
                                                                IconButton(
                                                                  onPressed:
                                                                      ...
                                                                      builder: (context) =>
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onSubmit:
                                                                            ...
                                                                            Duration
                                                                                diff =
                                                                                endDate.add(const Duration(days: 1)).difference(date);

                                                                            Duration
                                                                                calcDelay =
                                                                                endDate.difference(getEndDate!);
                                                                            print(endDate);
                                                                            print(getEndDate);
                                                                            ...
                                                                            if (dataRowIndex !=
                                                                                null) {
                                                                              _employees[dataRowIndex].actualstartDate = DateFormat('dd-MM-yyyy').format(date);
                                                                              ...
                                                                              updateDataGrid(rowColumnIndex: RowColumnIndex(dataRowIndex, 5));
                                                                              notifyListeners();
                                                                            }
                                                                            if (dataRowIndex !=
                                                                                null) {
                                                                              _employees[dataRowIndex].actualendDate = DateFormat('dd-MM-yyyy').format(endDate);
                                                                              ...
                                                                              updateDataGrid(rowColumnIndex: RowColumnIndex(dataRowIndex, 6));

                                                                              notifyListeners();
                                                                            }
                                                                            if (dataRowIndex !=
                                                                                null) {
                                                                              _employees[dataRowIndex].actualDuration = int.parse(diff.inDays.toString());
                                                                              ...
                                                                              updateDataGrid(rowColumnIndex: RowColumnIndex(dataRowIndex, 7));
  ...
  void onCellSubmit(DataGridRow dataGridRow, RowColumnIndex rowColumnIndex,
    ...
    if (column.columnName == 'srNo') {
      ...
      dataGridRows[dataRowIndex].getCells()[rowColumnIndex.columnIndex] =
          DataGridCell<int>(columnName: 'QtyScope', value: newCellValue);
      _employees[dataRowIndex].scope = newCellValue as int;
  ...
  bool onCellBeginEdit(DataGridRow dataGridRow, RowColumnIndex rowColumnIndex,
      GridColumn column) {
    // 0, 2, 6, 13, 18, 28, 32, 38, 64, 76
    if (rowColumnIndex.rowIndex == 0 ||
            rowColumnIndex.rowIndex == 2 ||
            rowColumnIndex.rowIndex == 6 ||
            rowColumnIndex.rowIndex == 13 ||
            rowColumnIndex.rowIndex == 18 ||
            rowColumnIndex.rowIndex == 28 ||
            rowColumnIndex.rowIndex == 32 ||
            rowColumnIndex.rowIndex == 38 ||
            rowColumnIndex.rowIndex == 64 ||
