...
import '../../model_admin/daily_acdb_admin_model.dart';
import '../o&m_model/daily_acdb.dart';
import '../../style.dart';

class DailyAcdbManagementAdminDataSource extends DataGridSource {
  String cityName;
  String depoName;
  String userId;
  String selectedDate;
  ...
  List data = [];
  DailyAcdbManagementAdminDataSource(this._dailyproject, this.mainContext,
  ...
  @override
  List<DailyAcdbAdminModel> _dailyproject = [];
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    ...
    return DataGridRowAdapter(
      ...
      void addRowAtIndex(int index, DailyAcdbAdminModel rowData) {
