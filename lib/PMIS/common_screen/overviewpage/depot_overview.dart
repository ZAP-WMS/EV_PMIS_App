...
import '../../admin/datasource_admin/depot_overviewdatasource.dart';
...
class _DepotOverviewState extends State<DepotOverview> {
  ...
  final List<DepotOverviewModel> _employees = <DepotOverviewModel>[];
  ...
  void storeField() async {
    ...
    if (bytes != null) {
      await FirebaseStorage.instance
          .ref(
              'BOQSurvey/$cityName/${widget.depoName}/$userId/survey/${result!.files.first.name}')
          .putData(
            bytes!,
  ...
  overviewFieldstore(String cityName, String depoName) async {
    ...
    if (bytes != null) {
      await FirebaseStorage.instance
          .ref(
              'BOQSurvey/$cityName/$depoName/$userId/survey/${result!.files.first.name}')
          .putData(
            bytes!,
            //  SettableMetadata(contentType: 'application/pdf')
          );
