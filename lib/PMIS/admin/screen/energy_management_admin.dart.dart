...
import 'package:ev_pmis_app/PMIS/user/datasource/energymanagement_datasource.dart';
import 'package:ev_pmis_app/PMIS/provider/energy_provider_admin.dart';
import 'package:ev_pmis_app/style.dart';
import 'package:ev_pmis_app/PMIS/models/energy_management.dart';
...
class _EnergyManagementAdminState extends State<EnergyManagementAdmin> {
  ...
  EnergyProviderAdmin? _energyProvider;

  @override
  void initState() {
    _energyProvider = Provider.of<EnergyProviderAdmin>(context, listen: false);
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            width: _energydatasource.dataGridRows.length * 110,
                            child: BarChart(
