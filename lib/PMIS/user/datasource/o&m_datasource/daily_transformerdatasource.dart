...
class DailyTranformerDataSource extends DataGridSource {
  String cityName;
  String depoName;
  String userId;
  String selectedDate;
  ...
  List data = [];
  DailyTranformerDataSource(this._dailyproject, this.mainContext, this.cityName,
  ...
  @override
  List<DailyTransformerModel> _dailyproject = [];
  ...
  DataGridRowAdapter? buildRow(DataGridRow row) {
    ...
    return DataGridRowAdapter(
      ...
      void addRowAtIndex(int index, DailyTranformerDataSource rowData) {
